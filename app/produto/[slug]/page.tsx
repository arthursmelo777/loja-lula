...
export default async function ProductPage({
  ...
  // Só as avaliações aprovadas no painel chegam aqui — a consulta já filtra
  // por `approved`. As demais ficam visíveis apenas no admin e para quem as
  // escreveu, na própria tela do pedido.
